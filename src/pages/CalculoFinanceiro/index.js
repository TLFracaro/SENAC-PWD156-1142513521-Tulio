...
function cadastrar() {
    ...
    if (window.confirm("Dados preenchidos corretamente?")) {
        ...
        res.innerHTML = "O valor do emprestimo foi de ${vnum} com juros de ${jnum} no valor total de ${tot}, sendo cada parcela no valor de ${vpar}, e o total de parcelar ${pnum}"
    }
}
